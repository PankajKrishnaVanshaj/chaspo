...
const Billing = () => {
  ...
  const CreateSubscription = async () => {
    ...
    // For example, you might call an API to handle the subscription.
    try {
      // Simulate API call
          ...
          <div className="rounded-2xl bg-white border border-gray-200 p-6 shadow-sm sm:px-8 lg:p-12">
            ...
            <ul className="mt-6 space-y-2">
              <li className="flex items-center gap-1">
                ...
                <span className="text-gray-700"> Unlimited Words/Month </span>
              </li>
              ...
              <li className="flex items-center gap-1">
                ...
                {/* <span className="text-gray-700"> All Time History </span> */}
              </li>
            </ul>
