    ...
    <div>
      <header className="flex flex-wrap justify-between items-center w-full bg-white border-b border-gray-200 dark:bg-neutral-800 dark:border-neutral-700 py-4 px-5 sm:px-7 lg:px-9">
        <div className="flex items-center">
          <div className="flex justify-center items-center gap-3">
            ...
            <span
              className="font-extrabold text-2xl text-transparent bg-clip-text bg-gradient-to-br from-purple-900 via-red-500 to-purple-600"
              style={{
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
        <div className="flex justify-center">
          ...
          >
            <span
              className="font-bold text-transparent bg-clip-text bg-gradient-to-br from-purple-900 via-red-500 to-purple-600"
              style={{
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent",
              }}
        ...
        <div className="pt-4 px-4 mx-auto max-w-screen-xl text-center lg:pt-12 lg:px-12">
          <h1 className="block text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 dark:text-neutral-200">
            PK ChaSpo
            <div
              className="text-transparent bg-clip-text bg-gradient-to-br from-purple-900 via-red-500 to-purple-600"
              style={{
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent",
              }}
